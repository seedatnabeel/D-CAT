...
# # Example usage to add to README file for reviewers
# # Assuming a CSV file named 'data.csv' with 'target' as the target column
# data_file = 'data.csv'
# target_column = 'target'
# data_loader = MultiFormatDataLoader(data_file, target_column, data_type='csv')
# torch_dataloader = data_loader.get_dataloader()

# for batch_features, batch_targets in torch_dataloader:
